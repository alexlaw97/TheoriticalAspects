...
public class NonExactSolution {
    ...
    static String node = "16";
    static String k = "10";
    static int counterClique = 0; 
    static int counterClique2 = 0;
    static int count = 0;
    ...
    public static void main(String[] args) {
       ...
       FileWriter writer;
            try{
                writer = new FileWriter("C:\\Users\\MSI\\Desktop\\INTI Staff\\Theoritical Aaspects\\Non-ExactSolution-master\\time.txt" , true);
...
//        FileWriter writer2;
//        try{
//            writer2 = new FileWriter("C:\\Users\\MSI\\Desktop\\INTI Staff\\Theoritical Aaspects\\Non-ExactSolution-master - Comnination\\NonExactcliqueResult.txt" , true);
...
//        FileWriter writer3;
//        try{
//            writer3 = new FileWriter("C:\\Users\\MSI\\Desktop\\INTI Staff\\Theoritical Aaspects\\Non-ExactSolution-master - Comnination\\ExactcliqueResult2.txt" , true);
//            BufferedWriter buffer = new BufferedWriter(writer3);
//            String temp = String.valueOf(counterClique2);
//            buffer.write(i + "." + temp);
//            buffer.newLine();
//        buffer.close();
//            
...
//        }
     ...
     */
    private static boolean generateSolution2() 
    {
        System.out.print("\n");
        printSpecialLine(50, "-");
        System.out.print("\n                SOLUTION DETAILS\n");
        ...
        return NonexcliqueExists();
               
    }
    
    /**
     * Generate out the accuracy of the program
     *
     */
    public static int accuracySolution()
    {
        int times = count;
        double accuracy = 0;
        System.out.println(counterClique2);
        accuracy = ((double)counterClique2/times)*100;
        FileWriter writer3;
        try{
            writer3 = new FileWriter("C:\\Users\\MSI\\Desktop\\INTI Staff\\Theoritical Aaspects\\Non-ExactSolution-master - Comnination\\ExactcliqueResult2.txt" , true);
            BufferedWriter buffer = new BufferedWriter(writer3);
            String temp = String.valueOf(accuracy);
            buffer.write(temp);
            buffer.newLine();
            buffer.close(); 
        ...
        double accuracy2 = 0;
        accuracy2 = ((double)counterClique/times)*100;
        FileWriter writer2;
        try{
            writer2 = new FileWriter("C:\\Users\\MSI\\Desktop\\INTI Staff\\Theoritical Aaspects\\Non-ExactSolution-master - Comnination\\NonExactcliqueResult.txt" , true);
            BufferedWriter buffer = new BufferedWriter(writer2);
            String temp = String.valueOf(accuracy2);
            buffer.write(temp);
            buffer.newLine();
            buffer.close();
...
//            return 0;
     ...
     * @return true if clique exists and vice versa
     */
    public static boolean NonexcliqueExists()
    {
        ...
        while (iter.hasNext())
        {
            ...
            {
                counterClique2 = counterClique2 + 1;
