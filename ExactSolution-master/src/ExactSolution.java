...
public class ExactSolution {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < 50; i ++){  
            ...
            FileWriter writer;
            try{
                writer = new FileWriter("C:\\Users\\MSI\\Desktop\\INTI Staff\\Theoritical Aaspects\\ExactSolution-master- kel\\time.txt" , true);
        ...
        try{
            x++;
            writer2 = new FileWriter("C:\\Users\\MSI\\Desktop\\INTI Staff\\Theoritical Aaspects\\ExactSolution-master- kel\\cliqueResult.txt" , true);
            BufferedWriter buffer = new BufferedWriter(writer2);
            String temp = String.valueOf(x + "." + counterClique);
            buffer.write(temp);
            buffer.newLine();
        buffer.close();
